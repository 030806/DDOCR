...
results = Table(
    ...
    Column("terminal_number", String(500), nullable=False, server_default=""),
    Column("manual_confirmed", Boolean, nullable=False, server_default="0"),
    Column("table_note", String(1000), nullable=False, server_default=""),
    Column("table_revision", Integer, nullable=False, server_default="0"),
    Column("created_at", DateTime(timezone=True), nullable=False, server_default=func.now()),
